...
import sql_actions.SQLAction_AddService;
...
public class Handler_AddService extends HTTPHandler
{
	@Override
	public void handle(HTTPRequest req, HTTPResponse res) throws IOException
	{
		...
		Config.injector.<SQLModel_User>inject(SQLModel_User.class, new SQLAction_AddService(reqBody.getInt("user_id"), reqBody.getString("name"),
			Tools.escape(reqBody.getString("login")), Tools.escape(reqBody.getString("password"))));
